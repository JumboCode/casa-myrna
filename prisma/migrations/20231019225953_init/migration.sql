...
-- AddForeignKey
ALTER TABLE "Shift" ADD CONSTRAINT "Shift_primaryUserID_fkey" FOREIGN KEY ("primaryUserID") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Shift" ADD CONSTRAINT "Shift_backupUserID_fkey" FOREIGN KEY ("backupUserID") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
